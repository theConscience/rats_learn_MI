...
**У. Р. Миллер, С. Роллник «Мотивационное интервьюирование. Как помочь людям измениться» (4-е изд., 2023)** 
...
- Освоить «дух» МИ — партнёрство, принятие, сопереживание и извлечение внутренних ресурсов.

---

### 2. Главная идея  
**МИ — это совместная, ориентированная на цель беседа, усиливающая личную мотивацию человека к изменению**.
Когда помогающий занимает исключительно директивную позицию («я знаю, как тебе надо»), амбивалентный человек начинает защищать противоположную сторону — и изменения не происходит.  
...
|---------|-------------------|
| **Амбивалентность** | Одновременное «хочу и не хочу» менять что-то; нормальная точка, где люди часто «зависают». |
...
| **Выпрямительный рефлекс** | Желание специалиста немедленно «исправить» клиента, что усиливает его сопротивление. |
| **Три стиля помощи** | <br>**Директивный** — «я решаю»<br>**Сопровождающий** — «я просто рядом»<br>**Ориентирующий (гид)** — «мы идём вместе, но направление ясно» |
...
4. **Извлечение** — доставать уже имеющиеся у человека причины и силы для перемен, а не «загружать» его своими.
---
...
- Какие четыре процесса описывают ход МИ? (Подсказка: вовлечение → фокусирование → побуждение → планирование).
...
Ключевая проверка: **«Это танец или перетягивание каната?»**
...
3. Заметьте, как собеседник *пошёл вслед* за этой частью — вероятность развернуть «изменяющую речь» резко возрастает.
...
MI-аудит показывает: опытный консультант выдаёт **≈ 2–3 рефлексии на каждый вопрос**; в «обычных» сессиях соотношение нередко 1 : 10 в пользу вопросов — и разговор превращается в допрос.  
...
| **Усиленная** | «Вам *совсем невыносимо* жить в таком ритме» | нарочно усиливает, чтобы проверить или скорректировать переживание |
| **Двусторонняя** | «С одной стороны… с другой…» | бережно «подсвечивает» амбивалентность |

> **Трюк:** если чувствуете, что «ходите по кругу» — поднимайтесь на более *сложный* уровень отражения .

---

#### 2. **Открытые вопросы 2-го уровня**  
За любой open-question должна последовать минимум *одна* рефлексия, иначе клиенту остаётся защищаться. Ищем вопросы, ответом на которые станет **изменяющая речь** .
...
> **Избегайте «мнимо-открытых»** («Вы хотите бросить *полностью* или *половину*?») — они тайком ограничивают выбор.

---

#### 3. **Аффирмации ≠ похвала**  
- Фокус не на вас («*Я горжусь…*»), а на клиенте: «*Вы вложили много сил, чтобы прийти сюда вовремя*».  
- Подмечайте **качества** («Настойчивость», «Гибкость»), **микро-успехи** («-96 % употребления по сравнению с началом»).  
- Культура → дозировка: там, где восторженное «Супер!» звучит как гипербола, лучше скромное признание вклада.

---

#### 4. **Резюме — куплеты в альбоме**  
Короткое «пауза-стоп» помогает клиенту увидеть узор своих слов, а вам — плавно сменить процесс (вовлечение → фокус → побуждение…):
...
*ЖСПН (DARN)* — «подготовка», *ГАП (CAT)* — «мобилизация» к действию.  
...
|-------|-----------|-------------|--------|
| **Отражение + уточняющий «хвост»** | «…и потому для вас это важно, *потому что*…?» | «Хочу дышать свободно… — …потому что тогда бег снова станет в радость?» | |
| **Двусторонняя рефлексия** | Соединяем «за» и «против» союзом **и** | «Сигарета снимает стресс, **и** вы устали от одышки» | |
| **Усиленная (amplified) рефлексия** | Чуть «перебарщиваем» сторону status quo | «То есть вреда почти нет?» → провоцирует «Ну как же…» | |
| **Открытый вопрос-«развертка»** | «Что бы изменилось, если …?» – запускает Reasons | «Что стало бы проще, если дышалось свободнее?» | |

---

#### 3. Тонкая работа рефлексиями  

- **Соотношение**: ≈ **2–3 рефлексии на 1 вопрос** — иначе беседа скатывается в допрос.
- **Глубина**:  
  - *Простая* («Вы устали»)  
  - *Сложная* — добавляем смысл («…и уже при одной мысли о ступеньках — тяжело»)  
  - *Продолженное высказывание* — предлагаем возможное «следующее» («Кажется, вы готовы убрать лишние сигареты, чтобы проверить, как изменится дыхание?») 
